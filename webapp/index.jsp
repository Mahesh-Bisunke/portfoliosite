...
<body>
	...
	<nav class="navbar navbar-expand-sm navbar-light">
		<div class="container">
			<a class="navbar-brand" href="index.html"><i class='uil uil-user'></i>Mahesh Bisunke</a>
					...
					<div class="about-text">
						...
						<h1 class="animated animated-text">
							<span class="mr-2">Hey folks, I'm</span> <span
								class="animated-info"> <span class="animated-item">
									</span> <span class="animated-item">SWE</span>
							</span>
						</h1>
                    ...
                    <div class="item">
                        <div class="project-info">
                            <img src="myproject/<%= projectFile.getFilename() %>" 
                                 ...
                                 alt="Project Image"
                                 style="max-height: 350px; border-radius: 10px; object-fit: cover; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
                        </div>
                    </div>
			...
			<div class="row">
				...
				<div class="col-lg-5 mr-lg-5 col-12">
					<div class="google-map w-100">
						<iframe
							src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3533.6397604066615!2d85.32963387451848!3d27.666615127288605!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2s!5e0!3m2!1sne!2snp!4v1753263749075!5m2!1sne!2snp"
					...
					<div
						...
						<div class="contact-info-item">
							...
							<p class="footer-text mb-0">+977 9869888923</p>
							<p>
								<a href="mailto:maheshbisunke92@gmail.com">maheshbisunke92@gmail</a>
							</p>
						</div>

						<ul class="social-links">
							<li><a
								href="https://linkedin.com/in/mahesh-bisunke-718b7a242/"
								class="uil uil-dribbble" data-toggle="tooltip"
								data-placement="left" title="Linkedin"></a></li>
							<li><a href="https://github.com/Mahesh-Bisunke"
			...
			<div class="row">
				...
				<div class="col-lg-12 col-12">
					<p class="copyright-text text-center">Copyright &copy; 2025
						*Mahesh Bisunke* All rights reserved</p>
...
<script>
    $(document).ready(function(){
        $(".owl-carousel").owlCarousel({
            ...
            margin: 20,
            nav: true,
            navText: ["<span>&#10094;</span>", "<span>&#10095;</span>"], // left and right arrows
            items: 1,
            center: true,
            autoplay: true,
